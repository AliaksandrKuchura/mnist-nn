...
class SigmoidActivationFunctionTest {
    ...
    private ActivationFunction sigmoid = new SigmoidActivationFunction();
    ...
    void apply() {
        ...
        for (int i = 0; i < inputs.length; i++) {
            double actualValue = sigmoid.apply(inputs[i]);
    ...
    void applyDifferential() {
        ...
        for (int i = 0; i < inputs.length; i++) {
            double actualValue = sigmoid.applyDerivative(inputs[i]);
